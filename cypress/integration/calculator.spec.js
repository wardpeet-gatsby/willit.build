describe("Calculator", () => {
  ...
  // NOTE: This test disabled temporarily because we only have data for
  // one CMS.
  ...
  //   cy.url().should(
  //     "contain",
  //     "/calculator/type/blog/source/cosmicjs/page-count/516"
  //   )
  // })

  // it("should move when selecting 32772 in the page count control dropdown", () => {
  ...
  //   cy.url().should(
  //     "contain",
  //     "/calculator/type/blog/source/mdx/page-count/32772"
  //   )
  // })
})
